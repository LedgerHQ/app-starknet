...
def test_clear_sign_tx_v1(firmware, backend, navigator, test_name):
    ...
    file_path = 'tools/apdu-generator/apdu_samples/erc20_transfer_v1.dat'
...
def test_blind_sign_tx_v1(firmware, backend, navigator, test_name):
    ...
    file_path = 'tools/apdu-generator/apdu_samples/random_v1.dat'
    all_apdus = read_lines_from_file(file_path)
