...
use nanos_ui::bagls::se;

use crate::{utils::print::{printf_slice, printf}, context::FieldElement};
...
const PEDERSEN_SHIFT: ECPoint = ECPoint {
    ...
    y: [0x03, 0xca, 0x0c, 0xfe, 0x4b, 0x3b, 0xc6, 0xdd, 0xf3, 0x46, 0xd4, 0x9d, 0x06, 0xea, 0x0e, 0xd3,
